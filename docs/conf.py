...
# -*- coding: utf-8 -*-
#
# hstrat-recomb-concept documentation build configuration file, created by
...
project = u'Hereditary Stratigraph Recombination Proof of Concept'
...
htmlhelp_basename = 'hstrat-recomb-conceptdoc'
...
latex_documents = [
    (master_doc, 'hstrat-recomb-concept.tex',
     u'Hereditary Stratigraph Recombination Proof of Concept Documentation',
...
man_pages = [
    (master_doc, 'hstrat-recomb-concept',
     u'Hereditary Stratigraph Recombination Proof of Concept Documentation',
     [author], 1)
]
