...
Finally, Section \ref{sec:software-data} describes software and data associated with this work.
...
Computation of credible intervals facilitates bayesian inference from population size estimators.
