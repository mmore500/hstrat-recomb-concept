...
Section \ref{sec:example-ne-inference} explains population size inference over an example evolutionary replicate.
...
The remaining 50-member subbpopulation and the five new 10-member subpopulations then evolve independently with no migration for a further 50 generations.
...
This scenario is called a ``weak'' sweep. %CITE
